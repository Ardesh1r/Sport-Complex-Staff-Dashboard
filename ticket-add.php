                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    <h4>افزودن بلیت جدید</h4>

                                </div>
                                <div class="tab-inn">
                                    <form method="post" action="upload-ticket-insert.php">
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input name="type" type="text" class="validate" required>
                                                <label style="text-align: center; for=" last_name">نوع بلیت</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input name="price" type="text" class="validate" required>
                                                <label style="text-align: center; for=" first_name">قیمت</label>
                                            </div>
                                        </div>

            ...
            <div class="sb2-1">
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        <li><a href="index-2.html"><i class="fa fa-bar-chart" aria-hidden="true"></i> Dashboard</a>
                        </li>
                        <li><a href="javascript:void(0)" class="collapsible-header active"><i class="fa fa-list-ul" aria-hidden="true"></i> Listing</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    ...
                                    <li><a href="listing-cat-all.html" class="menu-active">ویرایش اطلاعات کارمندان</a>
                                    </li>
            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> listing Categories</a>
                        </li>
                    </ul>
                </div>
                <div class="sb2-2-1">
...
<!-- Mirrored from rn53themes.net/themes/demo/lava-admin/listing-cat-all.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 09:31:47 GMT -->
</html>